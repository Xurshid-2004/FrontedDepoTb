...
export const api = {
  ...
  editKip: (id: string, patch: { liniya?: string; sana?: string; muddatOy?: number; muddatKun?: number | null }) =>
  ...
  setKorik: (b: {
    turi: "tibbiy" | "psixolog";
    workerId: string;
    sana?: string | null;
    muddatOy?: number;
    tugash?: string;
    izoh?: string;
  }) => amal("/koriklar", "POST", b),

  deleteKorik: (workerId: string, turi: "tibbiy" | "psixolog") =>
    amal(`/koriklar/${workerId}/${turi}`, "DELETE"),
